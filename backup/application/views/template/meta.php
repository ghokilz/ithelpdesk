...
<!-- <body class="hold-transition sidebar-mini layout-navbar-fixed layout-footer-fixed"> for light -->
<!-- <body class="hold-transition dark-mode sidebar-mini layout-navbar-fixed layout-footer-fixed"> for dark mode -->
